...
from coco_utils import (
    ...
    eval_on_ILSVRC12)
from resnet_model_coco_aspp_ori_gn import (
...
#Joint Train
TOTAL_BATCH_SIZE = 8
# EPOCH_TIME = int(32/TOTAL_BATCH_SIZE)
EPOCH_TIME = 1
...
class Model(MSC_Model):
    ...
    def get_logits(self, image):
        with argscope([Conv2D, GrConv2D, MaxPooling, GlobalAvgPooling, BatchNorm], data_format=self.data_format):
...
def get_config(model, fake=False):
    ...
    if fake:
        ...
        callbacks = [
            ModelSaver(),
            ScheduledHyperParamSetter('learning_rate', [(0, 2.5e-4), (20, 1.25e-4), (40, 5e-5), (60, 2.5e-5),(80, 1e-5), (100, 5e-6), (120, 2.5e-6)]), 
            HumanHyperParamSetter('learning_rate'),
        ]
        # Finetune COCO
        #[(0, 2.5e-3), (20, 1.25e-3), (40, 5e-4), (60, 5e-5),(80, 2.5e-5), (100, 1.25e-5), (120, 5e-6)]
        #JT COCO
    ...
    return TrainConfig(
        ...
        callbacks=callbacks,
        steps_per_epoch=1522*EPOCH_TIME,
        max_epoch=140,
        nr_tower=nr_tower
    )
    #Joint Train
